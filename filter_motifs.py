...
file_motif = open(path + "ToyMotifData.txt", "r")                       # opens the file that contains the motif data
original = file_motif.readlines()                                       # reads all the data
file_motif.close()

file_names = open(path + "mart_export.txt", "r")                        # opens the file that contians the name-id relation
